...
return (
    <tr className="tracking-wide text-gray-600 hover:text-black hover:cursor-pointer border-y-2">
      ...
      <td onDoubleClick={handleClicked} className="text-left text-black font-semibold hover:underline">{data.material_id}</td>
      ...
      <td className="text-center">{formatMaterialQuantity(data.material_quantity)}</td>
